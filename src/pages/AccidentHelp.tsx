...
import { Phone, ArrowDown, ShieldCheck, Car, Headset, CheckCircle2, ChevronDown, Lightbulb } from 'lucide-react';
...
const AccidentHelp: React.FC = () => {
  return (
    <div className="bg-white min-h-screen relative font-sans pb-[56px] md:pb-0">
      <SEO 
        title="Accident Help & Advice Australia | Not At Fault Rights"
        description="Not sure what to do after your accident? Get free expert advice on your rights as a not-at-fault driver. No excess, free repairs, and loan car help."
        canonical="https://notatfaultclaims.com.au/accident-help"
        breadcrumbs={[
          { name: 'Home', item: 'https://notatfaultclaims.com.au' },
          { name: 'Accident Help', item: 'https://notatfaultclaims.com.au/accident-help' }
        ]}
      />
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-[60%]">
            <p className="font-mono text-[11px] text-[#FF5C00] uppercase tracking-[0.15em] mb-4 font-bold">
              ACCIDENT HELP — KNOW YOUR RIGHTS
            </p>
            ...
            <p className="font-sans text-[16px] text-[#6B6B6B] max-w-[480px] mb-8 leading-relaxed">
              Most Australians don't know their rights after a not-at-fault accident. You may not have to pay a cent. We explain everything and handle the entire claim — repairs, insurers, and a free loan car — at zero cost to you.
            </p>
      ...
      <section className="bg-[#F4F4F4] py-[18px] border-y border-[#E0E0E0]">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center sm:justify-between items-center gap-y-4 gap-x-2">
            {[
              { icon: Lightbulb, label: "KNOW YOUR RIGHTS" },
              { icon: ShieldCheck, label: "NO EXCESS PAYABLE" },
              { icon: Car, label: "FREE LOAN CAR" },
              { icon: Headset, label: "WE HANDLE EVERYTHING" },
              { icon: CheckCircle2, label: "ZERO COST TO YOU" }
            ].map((item, idx) => (
      ...
      <section id="form-section" className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <h2 className="font-bebas text-[36px] text-[#1C1C1C] uppercase leading-tight mb-4">Get Free Advice Now.</h2>
            <p className="font-sans text-[16px] text-[#6B6B6B] max-w-[500px] mx-auto">
              Tell us what happened. We'll call you back in 15 minutes and walk you through exactly what to do next.
            </p>
          </div>
      ...
      <section className="bg-[#F4F4F4] py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-[800px]">
          ...
          <div className="bg-white rounded-[10px] shadow-[0_4px_24px_rgba(0,0,0,0.07)] p-4 md:p-8">
            {[
              { q: "Do I have to pay excess if it wasn't my fault?", a: "No. If you were not at fault, the cost is recovered from the other driver's insurer. You pay nothing." },
              { q: "Should I call my own insurer first?", a: "No — call us first. Going through your own insurer can cost you excess and affect your premium. We handle it a better way." },
              { q: "What if I don't know if I was at fault?", a: "Call us and explain what happened. We'll assess the situation and tell you exactly where you stand — at no cost." },
              { q: "How long do I have to make a claim?", a: "Act as quickly as possible. The sooner you call us, the sooner we can preserve evidence and protect your position." },
              { q: "What information do I need to get started?", a: "Just the basics — the other driver's details, your rego, and a brief description of what happened. We do the rest." }
            ].map((faq, idx) => (
      ...
      <section className="bg-[#FF5C00] py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-bebas text-[40px] text-white uppercase leading-tight mb-4">Not Sure What To Do After Your Accident?</h2>
          <p className="font-sans text-[16px] text-white opacity-90 max-w-[600px] mx-auto mb-8">
            Call us now — free advice, free repairs, zero cost if it wasn't your fault.
          </p>
          <a 
            href={`tel:${PHONE_NUMBER.replace(/\s/g, '')}`} 
            onClick={() => fireEvent('phone_number_click')}
