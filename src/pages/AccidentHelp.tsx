...
const AccidentHelp: React.FC = () => {
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', "Not sure what to do after your accident? Free advice, no excess, free loan car. We handle everything. Zero cost. Call 0485 044 333.");
