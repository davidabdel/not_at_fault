...
import { Phone, ArrowDown, ShieldCheck, Car, Headset, Wrench, CheckCircle2, ChevronDown } from 'lucide-react';
...
const NotAtFaultRepairs: React.FC = () => {
  return (
    <div className="bg-white min-h-screen relative font-sans pb-[56px] md:pb-0">
      <SEO 
        title="Not At Fault Accident Repairs | Zero Cost & Free Loan Car"
        description="Had an accident that wasn't your fault? We handle repairs, insurers & your free loan car. No excess. Zero cost. Australia-wide service."
        canonical="https://notatfaultclaims.com.au/not-at-fault-repairs"
        breadcrumbs={[
          { name: 'Home', item: 'https://notatfaultclaims.com.au' },
          { name: 'Repairs', item: 'https://notatfaultclaims.com.au/not-at-fault-repairs' }
        ]}
      />
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-[60%]">
            ...
            <p className="font-sans text-[16px] text-[#6B6B6B] max-w-[480px] mb-8 leading-relaxed">
              No excess. No hassle. Free loan car. We manage your entire insurance claim and smash repair — at zero cost to you.
            </p>
      ...
      <section id="form-section" className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <h2 className="font-bebas text-[36px] text-[#1C1C1C] uppercase leading-tight mb-4">Tell Us What Happened.</h2>
            <p className="font-sans text-[16px] text-[#6B6B6B] max-w-[500px] mx-auto">
              We'll call you back within 15 minutes. No paperwork, no hassle — just tell us the basics and we'll take it from here.
            </p>
          </div>
      ...
      <section className="bg-[#F4F4F4] py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-20">
            ...
            <h2 className="font-bebas text-[36px] text-[#1C1C1C] uppercase leading-tight">Three Steps. Zero Cost.</h2>
          </div>
      ...
      <section className="bg-[#F4F4F4] py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-[800px]">
          ...
          <div className="bg-white rounded-[10px] shadow-[0_4px_24px_rgba(0,0,0,0.07)] p-4 md:p-8">
            {[
              { q: "Do I have to pay excess if the accident wasn't my fault?", a: "No. Because you were not at fault, the cost of your repairs is recovered from the at-fault driver's insurer. You pay no excess and nothing out of pocket." },
              { q: "How quickly can you arrange a loan car?", a: "In most cases we can have a like-for-like loan car to you within 30 minutes of your call. If you drive an SUV, you get an SUV." },
      ...
      <section className="bg-[#FF5C00] py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-bebas text-[40px] text-white uppercase leading-tight mb-4">Had an accident that wasn't your fault?</h2>
          <p className="font-sans text-[16px] text-white opacity-90 max-w-[600px] mx-auto mb-8">
            Call us now — we'll take it from here. No excess, no hassle, zero cost to you.
          </p>
          <a 
            href={`tel:${PHONE_NUMBER.replace(/\s/g, '')}`} 
            onClick={() => fireEvent('phone_number_click')}
