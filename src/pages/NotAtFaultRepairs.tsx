...
const NotAtFaultRepairs: React.FC = () => {
  useEffect(() => {
    document.title = "Not At Fault Accident Repairs — Zero Cost | Not at Fault Claims";
    ...
    metaDescription.setAttribute('content', "Had an accident that wasn't your fault? We handle repairs, insurers & your free loan car. No excess. Zero cost. Call 0485 044 333.");
    ...
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'page_view', {
        ...
        page_title: "Not At Fault Accident Repairs — Zero Cost | Not at Fault Claims"
      });
    }
